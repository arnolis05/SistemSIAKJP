            ...
            <div class="table-mod">
                <table class="table-content-list">
                    <tr class="row-table">
                        ...
                        <th class="header-table">Nama Minyak</th>
                    ...
                    @foreach($query as $q)
                        <tr class="row-table">
                            ...
                            <td class="desc-table">{{ $q->namaMinyak }}</td>
                            <td class="desc-table center-content">
                                <div class="box-action-0">
                                    <i class="fa fa-pen-to-square pointer" onclick="editJenis('{{ encrypt($q->id,0.10 )}}')"></i> | 
                                    <form method="post" action="/minyak/{{ encrypt($q->id,0.10 ) }}">
                                        @csrf()
                                        @method('delete')
                                        <button class="btn-trash-0" type="submit" value="delete"><i class="fa fa-trash pointer"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
